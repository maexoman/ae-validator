 ...
 */
export declare function Length(length: number): PropertyDecorator;
/**
 ...
 * @returns TypeScript Property-Decorator
 */
export declare function MaxLength(maximum: number): PropertyDecorator;
/**
 ...
 * @returns TypeScript Property-Decorator
 */
export declare function Pattern(pattern: RegExp): PropertyDecorator;
